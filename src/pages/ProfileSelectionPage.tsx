...
export function ProfileSelectionPage() {
    ...
    // Add this to your ProfileSelectionPage.tsx or run once to give child profiles initial points
    // In ProfileSelectionPage.tsx, update the handleAddChild function:
    const handleAddChild = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newProfile: ChildProfile = {
                ...
                points: 100, // Give child 100 starting points
                currentStreak: 0,
                longestStreak: 0,
                badges: [],
                completedTasks: 0
            ...
            await setDoc(doc(db, COLLECTIONS.USERS, childProfileId), {
                id: childProfileId,
                email: `${childProfileId}@child.local`,
